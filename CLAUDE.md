...
Live and healthy. Production = `9d03e97`; all Jul-4 QC and improvement groups (G2/G3/G5–G8) are deployed. History: `archive/STATUS-HISTORY-2026-07.md`.
**⚠️ Scheduled task `luca-bistro-worldcup-schedule`** (Mondays ~8:07 AM, maintains fixtures + results line, standing exception: keep both Sat Jul 11 QF rows) **still points at the old repo path — owner must repoint it to this folder.**
...
- **Enhancements (owner picks):** G9 submit sitemap in Google Search Console (biggest free SEO lever) · G10 newsletter signup via existing Web3Forms pattern · G11 private-events callout · G12 lazy-loaded map · G13 Instagram link tile (@lucabistro84, no embed). Optional: re-export 103 KB `logo.png` at 2×.
