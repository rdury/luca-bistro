...
**World Cup "Watch Parties" (Jul 12 evening, reversing the earlier archival — Raymond reopened for the games):** Current Events tab (renamed "What's On Now") leads with a parchment `.parchment-panel` (same gilt-frame treatment as the menus) titled Watch Parties, big blue `.wc-allez` "Allez les Bleus!", listing France v Spain (Tue: bar & snacks 3–5 PM only, closes 5 PM), England v Argentina (Wed: bar & snacks 3–5, dinner from 5) and The Final (Sun: bar & snacks 3–5, closes 5 PM). No 3rd-place game shown. Hero banner enlarged to max-width 780px. Tuesday notices + JSON-LD specialOpeningHours updated to match (Tue 15–17; Wed 10–14/15–21; Sun 10–14/15–17). Scheduled tasks `luca-tuesday-closure-reversal` (Wed 9 AM) and `luca-worldcup-banner-timeout` (Mon Jul 20 9 AM) hold the cleanup duties — their prompts describe the current markup. Daily task `luca-worldcup-daily` remains disabled.
