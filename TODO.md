...
## 🔁 Ongoing / recurring
- [ ] 🤖+🧑 **Each visit** — reply to more old unreplied Google reviews in Frédéric's voice (draft → Raymond approves → post via GBP owner reply wizard). **Backlog: ~79** (Jul 23 2026 — the old "34" was wrong; the wizard header showed **85 unreplied** before this batch and 81 after the first four). Rules: never encourage "ask for [person]"; no free-item implications; no email addresses in replies; 1★s = acknowledge, no excuses, point to the fix, invite back.
  - **Jul 23 batch — 6 POSTED:** Edward 5★, Triad Oineski 5★, Janice Gerda 5★, malaika vaz 1★ (no text), Julia P 5★ (hours caveat), Liz Jordan 5★.
  - **APPROVED BUT NOT YET POSTED (drafts ready, post these first next time):** **Conor Brown** 5★ ("My favorite restaurant") and **Mary Kidd Ray** 5★ (comfort food on a snowy night) — both approved Jul 23, ~positions 7 and 10 in the newest-sorted unreplied queue.
  - **ALSO DRAFTED, awaiting a future batch:** Joey Tornes 1★ (closed when listed open), Rhonda Tepe 5★ (birthday for Maman), Julie Robers 5★ (regular), Austin Guerin 5★ (fair pricing), James Rahner 5★ ("the ideal restaurant"), Christina Joey 1★ (slow service, claims owner won't hire — draft gently corrects: roles ARE posted).
  ...
  - ⚙️ **UI notes:** use the **"Reply to reviews" wizard** (Skip / Reply, one at a time) — the review list's own scrolling is virtualised and jumps unpredictably, and its inline "Reply" links do nothing. The wizard slows to 10–15 s per step after ~6 replies. Sort control ("Newest / Most relevant / Highest rating / Lowest rating") sits at the top of the list, not in the wizard.
